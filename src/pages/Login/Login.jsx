...
const Login = () => {
    ...
    return (
        <div className="w-full max-w-sm p-6 m-auto  rounded-lg shadow-md dark:bg-gray-800">
            ...
            <form className="mt-6" onSubmit={handleSubmit}>
              ...
              focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40"
                ...
                {/* captcha  */}
                <div className="mt-4">
                    <div className='flex justify-center'><LoadCanvasTemplate /></div>
                    <div className="flex items-center justify-between">
                        <label
                            htmlFor="password"
                            className="block text-sm text-gray-800 dark:text-gray-200"
              ...
              focus:ring-blue-300 focus:outline-none focus:ring focus:ring-opacity-40"
                    />
                    <div className='flex justify-center mt-2'> <button onClick={handelValidateCaptcha} className='btn btn-outline btn-xs'>Submit Captcha</button></div>
                </div>
                ...
                <div className="mt-6">
                    <button
                        disabled={disable}
                        type="submit"
                        className="w-full px-6 py-2.5 text-sm font-medium tracking-wide text-white 
              capitalize transition-colors duration-300 transform bg-gray-800 
            ...
            <div className="flex items-center mt-6 -mx-2">
                <button
                    type="button"
                    className="flex items-center justify-center w-full px-6 py-2 mx-2 text-sm font-medium text-white 
